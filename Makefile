...
SOURCES =	./srcs/convert/ft_allow.c ./srcs/convert/ft_itoa.c ./srcs/convert/ft_go_zero.c ./srcs/convert/ft_itoa_base.c ./srcs/convert/ft_smoker_atoi.c ./srcs/convert/ft_uitoa_base.c				\
\
